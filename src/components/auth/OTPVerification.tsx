      ...
      <Card className="w-full max-w-md">
        <div className="space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mt-2">Enter the 6-digit code sent to {email}</p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-xs text-blue-700">
            ...
            <p>Your account is protected with 2FA. This additional security step helps keep your account safe.</p>
          </div>
        </div>
      </Card>
    </div>
